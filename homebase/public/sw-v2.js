/* thay homebase — service worker v2
 ...
 *
 * v2: fixed Content-Encoding/Content-Length leak on scrubbed responses,
 * and versioned filename so Cloudflare's CDN cannot serve a stale copy.
 */
self.importScripts('/scrub-beacon-v2.js');
